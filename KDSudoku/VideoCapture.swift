...
public class VideoCapture: NSObject {
  ...
  func setUpCamera(sessionPreset: AVCaptureSession.Preset) -> Bool {
    ...
    guard let videoInput = try? AVCaptureDeviceInput(device: captureDevice) else {
      print("AVCaptureDeviceInput lässt sich nicht bauen")
      return false
    }
    ...
    //KD 190502 kann ich das auch benutzen, um das blöde Umrechnen der Orientierung im ViewController zu verhindern?
